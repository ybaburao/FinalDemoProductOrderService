...
public class OrderProductController {
	...
	@GetMapping("/listCart/{orderProductId}")
	public List<Order> listCartProducts(@PathVariable int orderProductId) throws OrderException {
		log.debug("fetching the products from cart ");
		return orderProductService.listCartProducts(orderProductId);
	}
	
	@GetMapping("/checkoutProducts/{orderProductId}")
	public String checkoutOrders(@PathVariable int orderProductId) throws OrderException{
		return orderProductService.checkoutOrders(orderProductId);
	}
